...
1. How many claims per year of **Incident_Date** are in the overall data? Be sure to include a plot.
2. Lastly, a user should be able to dynamically input a specific state value and answer the following: 
